      ...
      <nav className={'nav'}>
        ...
        <ul className={`nav__list ${openClose}`}>
          ...
          <li className="nav__item">
            <NavLink
              to="/artfinder"
              className={location.pathname === '/artfinder' ? 'active' : 'nav__link'}
              onClick={closeMenu}
            >
              ArtFinder
            </NavLink>
          ...
          <li className="nav__item">
            <NavLink
              to="/translator"
              className={location.pathname === '/translator' ? 'active' : 'nav__link'}
              onClick={closeMenu}
            >
              Translator
            </NavLink>
          ...
          <li className="nav__item">
            <NavLink
              to="/soulbuddy"
              className={
                location.pathname === '/soulbuddy' ? 'active' : 'nav__link'
              }
              onClick={closeMenu}
            >
              SoulBuddy
